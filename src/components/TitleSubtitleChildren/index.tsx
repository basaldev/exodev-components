 ...
 */
const TitleSubtitleChildren: FunctionComponent<IProps> = (props: IProps) => {
  const {
    titleText,
    subtitleText,
    children,
  ...
  const titleProps =
    typeof titleConfig !== 'undefined'
      ? { ...defaultTitleConfig, ...titleConfig }
      : defaultTitleConfig;
  const subtitleProps =
    typeof subtitleConfig !== 'undefined'
  ...
  return (
    <>
      <Grid container direction="column">
        ...
        <Grid item>
          {/* Subtitle */}
          <Typography variant={subtitleProps.variant}>
            {subtitleText}
          </Typography>
        </Grid>
